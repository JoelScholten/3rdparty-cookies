...
app.get('/authorize', (req, res) => {
    ...
    res.send(`<script>window.location.href = "https://joelscholten.eu.auth0.com/authorize?response_type=code&client_id=7wp3x2aJEE6z6gDZTuXV145NwJEtvg8O&redirect_uri=${beurl}/authorize_return&scope=openid+userid+profile+email+photos+offline_access&state=${state}&nonce=zMDZeydP1Ax_JVdy&audience=https://joelscholten.eu.auth0.com/api/v2/";</script>`);
});
